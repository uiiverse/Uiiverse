...
<div class="main-column"><div class="post-list-outline">
		...
		if(!$following_result->num_rows == 0){
			...
			while($following = $following_result->fetch_array()){
				...
				echo '<li class="trigger" data-href="/users/'. $follow_user['user_name'] .'/posts"><a href="/users/'. $follow_user['user_name'] .'/posts" class="icon-container"><img src="'. printFace($follow_user['user_face'], 0) .'" class="icon"></a>
