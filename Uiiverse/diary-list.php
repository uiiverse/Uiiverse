    ...
    if (!empty($title['title_by'])) {
      ...
      <div class="sidebar-post-menu">
        <a href="/titles/'. $title['title_id'] .'" class="sidebar-menu-in_game symbol arrow-button">
          ...
          <a href="/titles/'. $title['title_id'] .'/diary" class="sidebar-menu-diary symbol selected">
...
if (!empty($_SESSION['signed_in'])) {
    ...
    echo '<div class="sidebar-setting"><div class="sidebar-post-menu"></div></div></section></div><div class="main-column"><div class="post-list-outline"><h2 class="label label-diary_post symbol">
        <span class="label-diary_post-msgid">
          Nuevas Entradas del Diario de Juego
        </span>
      </h2>';
    ...
    <div class="empty post-list">
          <p>No se han publicado entradas del Diario de Juego</p>
        </div>';
}
