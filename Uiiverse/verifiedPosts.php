...
$tabTitle = 'Posts from Verified Users';
...
echo '<div class="main-column"><div class="post-list-outline">
  <div id="image-header-content">
    ...
    <img src="http://web.archive.org/web/20160326025435im_/https://d13ph7xrk1ee39.cloudfront.net/img/identified-user.png?u4xD0oronoRfrMbnw_vDqA">
  </div>
...
while($posts = $posts_result->fetch_array()){
	...
	echo '<div id="post-AYMHAAACAAADVHlBbXzaxw" data-href="/posts/' . $posts['id'] . '" class="post trigger post-subtype-default" tabindex="0">
	...
	echo '"><img src="' . printFace($user['user_face'], $posts['feeling_id']) . '" class="icon official-user"></a><div class="toggle-button">';
